...
<head>
	...
	<meta name="description" content="Login Siswa PADAS | Pangkalan Data Siswa SMK Negeri 1 Geger">
	...
	<title>Login Siswa | Pangkalan Data Siswa SMK Negeri 1 Geger</title>
							...
							<form method="POST" action="<?php echo base_url('login/verifikasi'); ?>" class="my-login-validation" novalidate="">
								...
								<div class="form-group">
									<label for="password">Password
										<a href="<?php echo base_url('login/lupa_password') ?>" class="float-right">
											Lupa Password?
										</a>
									</label>
