...
<head>
    ...
    <meta name="description" content="Reset Password Siswa | Pangkalan Data Siswa SMK Negeri 1 Geger">
    <meta name="viewport" content="width=device-width,initial-scale=1">

    <title>Reset Password Siswa | Pangkalan Data Siswa SMK Negeri 1 Geger</title>
                ...
                <div class="card-wrapper">
                    ...
                    <div class="card fat">
                        <div class="card-body">
                            ...
                            ?>
                            <form method="POST" action="<?php echo base_url('login/reset_password/') . $this->uri->segment(3); ?>" class="my-login-validation" novalidate="" autocomplete="off">
