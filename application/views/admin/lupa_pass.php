...
<head>
    ...
    <title>Lupa Password Admin | Pangkalan Data Siswa SMK Negeri 1 Geger</title>
                ...
                <div class="card-wrapper">
                    ...
                    <div class="card fat">
                        <div class="card-body">
                            ...
                            ?>
                            <form method="POST" action="<?php echo base_url('admin/login/lupa_password'); ?>" class="my-login-validation" novalidate="" autocomplete="off">
