...
<head>
    ...
    <meta name="description" content="Reset Password Admin | Pangkalan Data Siswa SMK Negeri 1 Geger">
    <meta name="viewport" content="width=device-width,initial-scale=1">

    <title>Reset Password Admin | Pangkalan Data Siswa SMK Negeri 1 Geger</title>
                ...
                <div class="card-wrapper">
                    ...
                    <div class="card fat">
                        <div class="card-body">
                            ...
                            ?>
                            <form method="POST" action="<?php echo base_url('admin/login/reset_password/') . $this->uri->segment(4); ?>" class="my-login-validation" novalidate="" autocomplete="off">
                                <div class="form-group">
                                    ...
                                    <div class="form-text text-muted">
                                        Pastikan password yang anda masukkan kuat dan mudah diingat.
                                    </div>
                                </div>
